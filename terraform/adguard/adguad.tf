...
resource "proxmox_virtual_environment_vm" "adguard_server" {
  node_name = "proxmox"
  name      = "adguard-server"
  started   = true
  ...
  description = "AdGuard server VM with Docker"
...
resource "null_resource" "docker_setup_and_run" {
  ...
  depends_on = [proxmox_virtual_environment_vm.adguard_server]
  ...
  inline = [
    "mkdir -p /home/bence/adguard",
    "mv /home/bence/docker-compose.yaml /home/bence/adguard/docker-compose.yaml",
    "cd /home/bence/adguard",
